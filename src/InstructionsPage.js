    ...
    return (
      <div className="instructionsPage">
        <div className="contentBox">
          <h1>KUNTOAJO-OHJE</h1>
          <h2>SAAPUMINEN, PYSÄKÖINTI</h2>
          Lähtö- ja maalialue on Porvoon Amiston edustalla, Perämiehentie 6, 06100 Porvoo.
          Alueella on laaja ilmainen pysäköintialue.
          ...
           
          <h2>AJON AIKANA MUUN LIIKENTEEN HUOMOIMINEN</h2>
          Osallistujien tulee noudattaa tieliikennelain ja -asetuksen mukaisia säädöksiä. Reittiä ei ole suljettu muulta liikenteeltä. Vilkkaimmissa risteyksissä on risteysvalvoja, ja reitti on merkattu kääntymisnuolilla. Osallistujien tulee noudattaa erityistä varovaisuutta risteyksissä.

          <h2>AJANOTTO</h2>
          Ajanotto on kaikille pää- ja kuntosarjaan osallistuville.
          ...
          Kuntoajoreitin varrella on roskaaminen kielletty. Huoltopisteiden yhteydessä on merkitty roskaamisalue. Osallistuja, joka roskaa, HYLÄTÄÄN.
          Mahdollisen rengasrikon varalta osallistujan on hyvä varata matkaan vararengas ja pumppu.
           
          <h2>LISÄTIETOJA</h2>
          Kuntoajonjohtaja Mathias Hannus  p. 050 376 0564<br/>
          Ratamestarit Kimmo Karhu p 0400 377 991/Patrik Hänninen p 040 354 2343<br/>
          Kisakanslia Terhi Järvikari p. 040 521 0631<br/>
          Tapahtuman kuuluttaja Markus Turunen  p. 045 876 6266<br/>
        </div>
      </div>
    )
  }
